...
1) games.ipynb (no se guardó First_Game_genres.csv)
2) items.ipynb (no se guardó Third_Users.csv)
3) reviews.ipynb (no se guardó Third_Users.csv)
...
4) combinaciones.ipynb; los archivos .csv ("df_unido_1.csv", "df_unido_2.csv", "df_unido_3.csv", "df_unido_4.csv", "df_unido_5.csv"; para ML: "df_unido_ML01.csv", "df_unido_ML02.csv") no se subieron por el gran tamaño.

5) Las consultas que se propones son las siguientes y se encuentran en la carpeta “Consultas”, con 2 notebooks “consultas.ipynb” y “ML_separado.ipynb”:
...
- Carpeta Consultas: “ML_separado.ipynb”.
